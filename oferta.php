    ...
    <section class="portfolio-block hire-me">
        <div class="container">
            ...
            <div class="form-group"><label for="subject">Rodzaj nieruchomości</label>
                <select name="rodzaj_nieruchomosci" class="form-control" id="subject">
                    <option value="land" selected="">gruntowe</option>
                    <option value="local">lokalowe</option>
                    <option value="building">budynkowe</option>
                </select></div>
            <div class="form-group"><label>Lokalizacja</label><input class="form-control" type="text" name="lokalizacja"></div>
            <div class="form-group"><label for="email">Rozmiar (m²)<br></label><input class="form-control" type="number" name="rozmiar" value="20" placeholder="20" min="5" max="5000" step="1"></div>
            <div class="form-group"><label for="email">Liczba pokoi<br></label><input class="form-control" type="number" name="liczba_pokoi" value="3" placeholder="3" min="5" max="5000" step="1"></div>
            <div class="form-group"><label for="email">Cena (PLN)<br></label><input class="form-control" type="number" name="cena" min="0" max="9999999" step="100"></div><label for="email">Walory<br></label>
            <div class="form-row">
                <div class="col">
